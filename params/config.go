...
type ChainConfig struct {
	...
	SunrisePhase0BlockTimestamp *uint64 `json:"sunrisePhase0BlockTimestamp,omitempty"`
...
func (c *ChainConfig) Description() string {
	...
	banner += fmt.Sprintf(" - Sunrise Phase 0 Timestamp:        @%-10v (https://github.com/chain4travel/caminogo/releases/tag/v0.2.0)\n", ptrToString(c.SunrisePhase0BlockTimestamp))
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, height *big.Int, time uint64) *ConfigCompatError {
	...
	if isForkTimestampIncompatible(c.SunrisePhase0BlockTimestamp, newcfg.SunrisePhase0BlockTimestamp, time) {
		return newTimestampCompatError("SunrisePhase0 fork block timestamp", c.SunrisePhase0BlockTimestamp, newcfg.SunrisePhase0BlockTimestamp)
	}
