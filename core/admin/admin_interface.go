...
func packFunctionSelector(addr common.Address, selector []byte) common.Hash {
	return common.BytesToHash(append(selector, addr.Bytes()...))
}

func BlacklistFunctionKey(addr common.Address, selector []byte) common.Hash {
