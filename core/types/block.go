...
type Header struct {
	...
	AccumulativeAddress common.Address `json:"accumulativeAddress"       gencodec:"required"`
...
func (b *Block) AccumulativeAddress() common.Address { return b.header.AccumulativeAddress }
