...
func (g *Genesis) KycVerifyInitialAdmin() error {
	key := admin.KycRoleKeyFromAddr(g.InitialAdmin)
	g.Alloc[common.HexToAddress("0x010000000000000000000000000000000000000a")].Storage[key] = common.HexToHash("0x1")
	return nil
}
