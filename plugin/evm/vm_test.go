...
var (
	...
	apricotSunrisePhase0 = params.Rules{IsApricotPhase1: true, IsApricotPhase2: true, IsApricotPhase3: true, IsApricotPhase4: true, IsApricotPhase5: true, IsSunrisePhase0: true}
)
