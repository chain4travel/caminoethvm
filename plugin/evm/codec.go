...
func InitCodec(durangoTime time.Time) error {
	var (
		lc       = linearcodec.NewCaminoDefault(durangoTime)
	...
	// Camino custom types
	errs.Add(lc.RegisterCustomType(&UnsignedCollectRewardsTx{}))
	lc.SkipCustomRegistrations(11)
	errs.Add(
		lc.RegisterCustomType(&secp256k1fx.MultisigCredential{}),
		lc.RegisterCustomType(&multisig.AliasWithNonce{}),
